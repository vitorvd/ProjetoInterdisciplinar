! function(t, e) {
                ...
                return function(t, e, n, a) {
                    var r, o, i, l, s = function(e) {
                            ...
                            return this.each((function() {
                                ...
                                if ("table" == this.nodeName.toLowerCase()) {
                                    L(d), P(d.column), I(d, d, !0), I(d.column, d.column, !0), I(d, t.extend(o, h.data()), !0);
                                    var p = s.settings;
                                    ...
                                    for (u = 0, r = w.length; u < r; u++) N(m, C ? C[u] : null);
                                    if (U(m, o.aoColumnDefs, w, (function(t, e) {
                                            H(m, t, e)
                                        })), T.length) {
                                        var F = function(t, e) {
                    ...
                    function A(t) {
                        ...
                        if (n && Le(n), t) {
                            ...
                            !t.sEmptyTable && a && "Nenhum resultado encontrado" === e.sEmptyTable && le(t, t, "sZeroRecords", "sEmptyTable"), !t.sLoadingRecords && a && "Loading..." === e.sLoadingRecords && le(t, t, "sZeroRecords", "sLoadingRecords"), t.sInfoThousands && (t.sThousands = t.sInfoThousands);
                            var r = t.sDecimal;
                            r && n !== r && Le(r)
                        }
                    }
                    ...
                    function H(e, n, r) {
                        ...
                        r !== a && null !== r && (P(r), I(s.defaults.column, r, !0), r.mDataProp === a || r.mData || (r.mData = r.mDataProp), r.sType && (o._sManualType = r.sType), r.className && !r.sClass && (r.sClass = r.className), r.sClass && l.addClass(r.sClass), t.extend(o, r), le(o, r, "sWidth", "sWidthOrig"), r.iDataSort !== a && (o.aDataSort = [r.iDataSort]), le(o, r, "aDataSort"));
                        var c = o.mData,
                            f = Y(c),
                    ...
                    function xt(t) {
                        ...
                        for (n = 0, r = t.aoData.length; n < r; n++)
                            if (!(u = t.aoData[n])._aFilterData) {
                                for (i = [], a = 0, o = c.length; a < o; a++)(e = c[a]).bSearchable ? (l = J(t, n, a, "filter"), f[e.sType] && (l = f[e.sType](l)), null === l && (l = ""), "string" != typeof l && l.toString && (l = l.toString())) : l = "", l.indexOf && -1 !== l.indexOf("&") && (wt.innerHTML = l, l = Ct ? wt.textContent : wt.innerText), l.replace && (l = l.replace(/[\r\n\u2028]/g, "")), i.push(l);
                    ...
                    function Lt(e) {
                        ...
                        if (0 !== n.length) {
                            ...
                            l !== i && (s += " " + a.sInfoFiltered), s = Pt(e, s += a.sInfoPostFix);
                    ...
                    function Bt(e) {
                        ...
                        e.scrollBarVis = V, F.children("thead, tfoot").remove(), R && (s = R.clone().prependTo(F), r = R.find("tr"), i = s.find("tr")), l = A.clone().prependTo(F), n = A.find("tr"), o = l.find("tr"), l.find("th, td").removeAttr("tabindex"), h || (C.width = "100%", v[0].style.width = "100%"), t.each(ft(e, l), (function(t, n) {
                            u = k(e, t), n.style.width = e.aoColumns[u].sWidth
                        })), R && Ut((function(t) {
                            t.style.width = ""
                        }), i), f = F.outerWidth(), "" === h ? (P.width = "100%", N && (F.find("tbody").height() > T.offsetHeight || "scroll" == w.css("overflow-y")) && (P.width = zt(F.outerWidth() - b)), f = F.outerWidth()) : "" !== p && (P.width = zt(p), f = F.outerWidth()), Ut(U, o), Ut((function(e) {
                            E.push(e.innerHTML), M.push(zt(t(e).css("width")))
                        }), o), Ut((function(e, n) {
                            -1 !== t.inArray(e, H) && (e.style.width = M[n])
                        }), n), t(o).height(0), R && (Ut(U, i), Ut((function(e) {
                        ...
                        }), i), F.outerWidth() < f ? (c = T.scrollHeight > T.offsetHeight || "scroll" == w.css("overflow-y") ? f + b : f, N && (T.scrollHeight > T.offsetHeight || "scroll" == w.css("overflow-y")) && (P.width = zt(c - b)), "" !== h && "" === p || ie(e, 1, "Possible column misalignment", 6)) : c = "100%", C.width = zt(c), m.width = zt(c), R && (e.nScrollFoot.style.width = zt(c)), g || N && (C.height = zt(L.offsetHeight + b));
                        var X = F.outerWidth();
                        ...
                        y[q] = J ? b + "px" : "0px", R && (I[0].style.width = zt(X), x[0].style.width = zt(X), x[0].style[q] = J ? b + "px" : "0px"), F.children("colgroup").insertBefore(F.children("thead")), w.trigger("scroll"), !e.bSorted && !e.bFiltered || e._drawHold || (T.scrollTop = 0)
                    }
                    ...
                    function Xt(n) {
                        ...
                        if (S || !v && !c && !u && d == W(n) && d == p.length)
                            for (a = 0; a < d; a++) {
                                ...
                                if (n.aoData.length)
                                    for (a = 0; a < h.length; a++) r = l[o = h[a]], t(Gt(n, o)).clone(!1).append(r.sContentPadding).appendTo(T);
                    ...
                    var _e = function(t, e) {
                        ...
                        Te = function(t, e) {
                            ...
                            if (n.length && t.length) {
                                ...
                                a._details && (a._detailsShow = e, e ? a._details.insertAfter(a.nTr) : a._details.detach(), we(n[0]))
                            }
                        },
                        we = function(t) {
                            var e = new o(t),
                    ...
                    i("cells()", (function(e, n, r) {
                        ...
                        oLanguage: {
                            ...
                            sInfo: "Apresentando _START_ a _END_ de _TOTAL_ resultados",
                            sInfoEmpty: "Apresentando 0 a 0 de 0 resultados",
                            sInfoFiltered: "(filtered from _MAX_ total entries)",
                            sInfoPostFix: "",
                            sDecimal: "",
                            sThousands: ",",
                            sLengthMenu: "Apresentar _MENU_ resultados",
    ...
    619: function(t, e, n) {
         ...
         */
        a = [n(0), n(620)], void 0 === (r = function(t) {
            return function(t, e, n, a) {
                "use strict";
