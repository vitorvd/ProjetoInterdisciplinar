                    ...
                    return function() {
                            ...
                            n && n.requirejs || (n ? t = n : n = {}, function(n) {
                                ...
                                s = function(e, t) {
                                    ...
                                    var o, u, p, h, f, m, w, b = [],
                                        A = typeof i;
                                    if (m = $(r = r || e), "undefined" === A || "function" === A) {
                                        for (t = !t.length && i.length ? ["require", "exports", "module"] : t, f = 0; f < t.length; f += 1)
                                            if ("require" === (u = (h = s(t[f], m)).f)) b[f] = a.require(e);
                                            else if ("exports" === u) b[f] = a.exports(e), w = !0;
                                        else if ("module" === u) o = b[f] = a.module(e);
                                        else if (g(l, u) || g(c, u) || g(d, u)) b[f] = _(u);
                                        else {
                                            if (!h.p) throw new Error(e + " missing " + u);
                                            h.p.load(h.n, v(r, !0), y(u), {}), b[f] = l[u]
                                        }
                                        p = i ? i.apply(l[e], b) : void 0, e && (o && o.exports !== n && o.exports !== l[e] ? l[e] = o.exports : p === n && w || (l[e] = p))
                                    } else e && (l[e] = i)
                            ...
                            return {
                                errorLoading: function() {
                                    return "Os resultados não conseguiram ser carregados."
                                },
                                ...
                                inputTooShort: function(e) {
                                    return "Por favor, insira " + (e.minimum - e.input.length) + " ou mais caracteres"
                                },
                        ...
                        })), n.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], (function(e, t, n, i, r, o, s, a, l, c, u, d, p, h, f, g, m, v, y, _, w, $, b, A, x, S, D, C, O) {
                            function E() {
                                this.reset()
                            }
                            return E.prototype.apply = function(u) {
                                ...
                                if (null == u.resultsAdapter && (u.resultsAdapter = n, null != u.ajax && (u.resultsAdapter = c.Decorate(u.resultsAdapter, A)), null != u.placeholder && (u.resultsAdapter = c.Decorate(u.resultsAdapter, b)), u.selectOnClose && (u.resultsAdapter = c.Decorate(u.resultsAdapter, D))), null == u.dropdownAdapter) {
                                    if (u.multiple) u.dropdownAdapter = w;
                                    else {
                                        var E = c.Decorate(w, $);
                                        u.dropdownAdapter = E
                                    }
                                    if (0 !== u.minimumResultsForSearch && (u.dropdownAdapter = c.Decorate(u.dropdownAdapter, S)), u.closeOnSelect && (u.dropdownAdapter = c.Decorate(u.dropdownAdapter, C)), null != u.dropdownCssClass || null != u.dropdownCss || null != u.adaptDropdownCssClass) {
