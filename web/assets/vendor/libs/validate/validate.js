! function(t, e) {
    ...
    310: function(t, e, a) {
         ...
         */
        n = [a(0)], void 0 === (r = "function" == typeof(i = function(t) {
            var e;
            t.extend(t.fn, {
                validate: function(e) {
                    if (this.length) {
                        ...
                        return a || (this.attr("novalidate", "novalidate"), a = new t.validator(e, this[0]), t.data(this[0], "validator", a), a.settings.onsubmit && (this.on("click.validate", ":submit", (function(e) {
                            ...
                            function i() {
                                var i, n;
                                return a.submitButton && (a.settings.submitHandler || a.formSubmitted) && (i = t("<input type='hidden'/>").attr("name", a.submitButton.name).val(t(a.submitButton).val()).appendTo(a.currentForm)), !(a.settings.submitHandler && !a.settings.debug) || (n = a.settings.submitHandler.call(a, a.currentForm, e), i && i.remove(), void 0 !== n && n)
                            }
                ...
                valid: function() {
                    var e, a, i;
                    return t(this[0]).is("form") ? e = this.validate().form() : (i = [], e = !0, a = t(this[0].form).validate(), this.each((function() {
                        (e = a.element(this) && e) || (i = i.concat(a.errorList))
                    })), a.errorList = i), e
                },
                rules: function(e, a) {
                    var i, n, r, s, o, d, l = this[0],
                        u = void 0 !== this.attr("contenteditable") && "false" !== this.attr("contenteditable");
                    if (null != l && (!l.form && u && (l.form = this.closest("form")[0], l.name = this.attr("name")), null != l.form)) {
                        if (e) switch (n = (i = t.data(l.form, "validator").settings).rules, r = t.validator.staticRules(l), e) {
                            case "add":
                                t.extend(r, t.validator.normalizeRule(a)), delete r.messages, n[l.name] = r, a.messages && (i.messages[l.name] = t.extend(i.messages[l.name], a.messages));
                                break;
                            case "remove":
                        ...
                        return (s = t.validator.normalizeRules(t.extend({}, t.validator.classRules(l), t.validator.attributeRules(l), t.validator.dataRules(l), t.validator.staticRules(l)), l)).required && (o = s.required, delete s.required, s = t.extend({
                            required: o
                ...
                messages: {
                    required: "É necessario preencher este campo.",
                    ...
                    maxlength: t.validator.format("Por favor, não ultrapasse mais de {0} caracteres."),
                    minlength: t.validator.format("Por favor, insira no mínimo {0} caracteres."),
                    rangelength: t.validator.format("Por favor, insira um valor entre {0} e {1} caracteres."),
                    range: t.validator.format("Por favor, a insira um valor entre {0} e {1}."),
                    max: t.validator.format("Por favor, a insira um valor menor ou igual a {0}."),
                    min: t.validator.format("Por favor, a insira um valor maior ou igual a {0}."),
                    step: t.validator.format("Por favor, a insira um valor múltiplo de {0}.")
                },
                autoCreateRanges: !1,
                prototype: {
                    init: function() {
                        ...
                        function n(e) {
                            ...
                            if (!this.form && i && (this.form = t(this).closest("form")[0], this.name = t(this).attr("name")), a === this.form) {
                    ...
                    element: function(e) {
                        var a, i, n = this.clean(e),
                            r = this.validationTargetFor(n),
                            s = this,
                            o = !0;
                        return void 0 === r ? delete this.invalid[n.name] : (this.prepareElement(r), this.currentElements = t(r), (i = this.groups[r.name]) && t.each(this.groups, (function(t, e) {
                    ...
                    elements: function() {
                        ...
                        return t(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter((function() {
                            ...
                            return !i && e.settings.debug && window.console && console.error("%o has no name assigned", this), n && (this.form = t(this).closest("form")[0], this.name = i), !(this.form !== e.currentForm || i in a || !e.objectLength(t(this).rules()) || (a[i] = !0, 0))
                        }))
                    },
                    clean: function(e) {
                        return t(e)[0]
                    ...
                    elementValue: function(e) {
                        ...
                        return "radio" === r || "checkbox" === r ? this.findByName(e.name).filter(":checked").val() : "number" === r && void 0 !== e.validity ? e.validity.badInput ? "NaN" : n.val() : (a = s ? n.text() : n.val(), "file" === r ? "C:\\fakepath\\" === a.substr(0, 12) ? a.substr(12) : (i = a.lastIndexOf("/")) >= 0 ? a.substr(i + 1) : (i = a.lastIndexOf("\\")) >= 0 ? a.substr(i + 1) : a : "string" == typeof a ? a.replace(/\r/g, "") : a)
                    },
                    check: function(e) {
                        e = this.validationTargetFor(this.clean(e));
                        var a, i, n, r, s = t(e).rules(),
                            o = t.map(s, (function(t, e) {
                                return e
                            })).length,
                            d = !1,
                            l = this.elementValue(e);
                        for (i in "function" == typeof s.normalizer ? r = s.normalizer : "function" == typeof this.settings.normalizer && (r = this.settings.normalizer), r && (l = r.call(e, l), delete s.normalizer), s) {
                            n = {
                                method: i,
                                parameters: s[i]
                            };
                            try {
                                ...
                                if (d = !1, "pending" === a) return void(this.toHide = this.toHide.not(this.errorsFor(e)));
                                if (!a) return this.formatAndAdd(e, n), !1
                            } catch (t) {
                    ...
                    defaultMessage: function(e, a) {
                        ...
                        var i = this.findDefined(this.customMessage(e.name, a.method), this.customDataMessage(e, a.method), !this.settings.ignoreTitle && e.title || void 0, t.validator.messages[a.method], "<strong>Warning: No message defined for " + e.name + "</strong>"),
                            n = /\$?\{(\d+)\}/g;
                        return "function" == typeof i ? i = i.call(this, a.parameters, e) : n.test(i) && (i = t.validator.format(i.replace(n, "{$1}"), a.parameters)), i
                    },
                    ...
                    showLabel: function(e, a) {
                        var i, n, r, s, o = this.errorsFor(e),
                            d = this.idOrName(e),
                ...
                attributeRules: function(e) {
                    ...
                    for (a in t.validator.methods) "required" === a ? ("" === (i = e.getAttribute(a)) && (i = !0), i = !!i) : i = r.attr(a), this.normalizeAttributeRule(n, s, a, i);
                ...
                dataRules: function(e) {
                    var a, i, n = {},
                        r = t(e),
                        s = e.getAttribute("type");
                    for (a in t.validator.methods) "" === (i = r.data("rule" + a.charAt(0).toUpperCase() + a.substring(1).toLowerCase())) && (i = !0), this.normalizeAttributeRule(n, s, a, i);
                    return n
                },
                staticRules: function(e) {
                    var a = {},
                        i = t.data(e.form, "validator");
                    return i.settings.rules && (a = t.validator.normalizeRule(i.settings.rules[e.name]) || {}), a
                },
                    ...
                    return t.each(e, (function(i, n) {
                        if (!1 !== n) {
                            if (n.param || n.depends) {
                                ...
                                r ? e[i] = void 0 === n.param || n.param : (t.data(a.form, "validator").resetElements(t(a)), delete e[i])
                            }
                        } else delete e[i]
                        ...
                        var a;
                        e[this] && (t.isArray(e[this]) ? e[this] = [Number(e[this][0]), Number(e[this][1])] : "string" == typeof e[this] && (a = e[this].replace(/[\[\]]/g, "").split(/[\s,]+/), e[this] = [Number(a[0]), Number(a[1])]))
                ...
                methods: {
                    ...
                    step: function(e, a, i) {
                        ...
                        return n = d(i), (d(e) > n || l(e) % l(i) != 0) && (u = !1), this.optional(a) || u
                    },
                    ...
                    remote: function(e, a, i, n) {
                        ...
                        return this.settings.messages[a.name] || (this.settings.messages[a.name] = {}), d.originalMessage = d.originalMessage || this.settings.messages[a.name][n], this.settings.messages[a.name][n] = d.message, i = "string" == typeof i && {
                            url: i
                        } || i, o = t.param(t.extend({
                            data: e
                        }, i.data)), d.old === o ? d.valid : (d.old = o, r = this, this.startRequest(a), (s = {})[a.name] = e, t.ajax(t.extend(!0, {
                            mode: "abort",
                            ...
                            success: function(t) {
                                ...
                                r.settings.messages[a.name][n] = d.originalMessage, l ? (o = r.formSubmitted, r.resetInternals(), r.toHide = r.errorsFor(a), r.formSubmitted = o, r.successList.push(a), r.invalid[a.name] = !1, r.showErrors()) : (i = {}, s = t || r.defaultMessage(a, {
                                    method: n,
                                    parameters: e
                                }), i[a.name] = d.message = s, r.invalid[a.name] = !0, r.showErrors(i)), d.valid = l, r.stopRequest(a, l)
                            }
                        }, i)), "pending")
                    }
                }
            ...
            return t.ajaxPrefilter ? t.ajaxPrefilter((function(t, e, a) {
                var n = t.port;
                "abort" === t.mode && (i[n] && i[n].abort(), i[n] = a)
    ...
    735: function(t, e, a) {
         ...
         * Released under the MIT license
         */
        n = [a(0), a(310)], void 0 === (r = "function" == typeof(i = function(t) {
            return function() {
                function e(t) {
                ...
                var e = 0,
                    ...
                    i = a.length;
                if (9 !== i) return !1;
                for (var n = 0; n < i; n += 3) e += 3 * parseInt(a[n], 10) + 7 * parseInt(a[n + 1], 10) + parseInt(a[n + 2], 10);
                return 0 !== e && e % 10 == 0
            }), "Please enter a valid routing number."), t.validator.addMethod("accept", (function(e, a, i) {
                var n, r, s = "string" == typeof i ? i.replace(/\s/g, "") : "image/*",
                    o = this.optional(a);
                if (o) return o;
                if ("file" === t(a).attr("type") && (s = s.replace(/[\-\[\]\/\{\}\(\)\+\?\.\\\^\$\|]/g, "\\$&").replace(/,/g, "|").replace(/\/\*/g, "/.*"), a.files && a.files.length))
                    for (r = new RegExp(".?(" + s + ")$", "i"), n = 0; n < a.files.length; n++)
                ...
                var a, i = t.replace(/ /g, ""),
                    n = 0,
                    r = i.length;
                for (a = 0; a < r; a++) n += (r - a) * i.substring(a, a + 1);
                return n % 11 == 0
                ...
                "use strict";
                if (this.optional(e)) return !0;
                var a, i, n, r, s = new RegExp(/^([ABCDEFGHJKLMNPQRSUVW])(\d{7})([0-9A-J])$/gi),
                    o = t.substring(0, 1),
                    d = t.substring(1, 8),
                    l = t.substring(8, 9),
                    u = 0,
                ...
                for (a = 0; a < d.length; a++) i = parseInt(d[a], 10), c(a) ? h += (i *= 2) < 10 ? i : i - 9 : u += i;
                ...
                for (n = 0, r = 9; n < 9; ++n, --r) s += +t.charAt(n) * r;
                for ((a = s % 11) >= 10 && (a = 0, o = 2), s = 0, n = 0, r = 1; n < 9; ++n, ++r) s += +t.charAt(n) * r;
                return (i = s % 11) >= 10 ? i = 0 : i -= o, String(a).concat(i) === t.substr(-2)
                ...
                for (var a = t.length - 2, i = t.substring(0, a), n = t.substring(a), r = 0, s = a - 7, o = a; o >= 1; o--) r += i.charAt(a - o) * s--, s < 2 && (s = 9);
                var d = r % 11 < 2 ? 0 : 11 - r % 11;
                if (d !== parseInt(n.charAt(0), 10)) return !1;
                a += 1, i = t.substring(0, a), r = 0, s = a - 7;
                for (var l = a; l >= 1; l--) r += i.charAt(a - l) * s--, s < 2 && (s = 9);
                ...
                if (11 !== (t = t.replace(/([~!@#$%^&*()_+=`{}\[\]\-|\\:;'<>,.\/? ])+/g, "")).length) return !1;
                var a, i, n, r, s = 0;
                if (a = parseInt(t.substring(9, 10), 10), i = parseInt(t.substring(10, 11), 10), n = function(t, e) {
                        var a = 10 * t % 11;
                ...
                for (a = t.length - 1; a >= 0; a--) i = t.charAt(a), r = parseInt(i, 10), s && (r *= 2) > 9 && (r -= 9), n += r, s = !s;
                return n % 10 == 0
            }), "Please enter a valid credit card number."), t.validator.addMethod("creditcardtypes", (function(t, e, a) {
                if (/[^0-9\-]+/.test(t)) return !1;
                t = t.replace(/\D/g, "");
                var i = 0;
                return a.mastercard && (i |= 1), a.visa && (i |= 2), a.amex && (i |= 4), a.dinersclub && (i |= 8), a.enroute && (i |= 16), a.discover && (i |= 32), a.jcb && (i |= 64), a.unknown && (i |= 128), a.all && (i = 255), 1 & i && (/^(5[12345])/.test(t) || /^(2[234567])/.test(t)) ? 16 === t.length : 2 & i && /^(4)/.test(t) ? 16 === t.length : 4 & i && /^(3[47])/.test(t) ? 15 === t.length : 8 & i && /^(3(0[012345]|[68]))/.test(t) ? 14 === t.length : 16 & i && /^(2(014|149))/.test(t) ? 15 === t.length : 32 & i && /^(6011)/.test(t) ? 16 === t.length : 64 & i && /^(3)/.test(t) ? 16 === t.length : 64 & i && /^(2131|1800)/.test(t) ? 15 === t.length : !!(128 & i)
            }), "Please enter a valid credit card number."), t.validator.addMethod("currency", (function(t, e, a) {
                var i, n = "string" == typeof a,
                    r = n ? a : a[0],
                    s = !!n || a[1];
                ...
                var a, i, n, r, s, o = !1;
                return /^\d{1,2}\/\d{1,2}\/\d{4}$/.test(t) ? (a = t.split("/"), i = parseInt(a[0], 10), n = parseInt(a[1], 10), r = parseInt(a[2], 10), o = (s = new Date(Date.UTC(r, n - 1, i, 12, 0, 0, 0))).getUTCFullYear() === r && s.getUTCMonth() === n - 1 && s.getUTCDate() === i) : o = !1, this.optional(e) || o
                ...
                if (this.optional(e)) return !0;
                var a, i, n, r, s, o = t.replace(/ /g, "").toUpperCase(),
                    d = "",
                    l = !0,
                    u = "";
                ...
                if (void 0 !== (n = {
                        ...
                        GB: "[A-Z]{4}\\d{14}",
                        VG: "[\\dA-Z]{4}\\d{16}"
                    } [o.substring(0, 2)]) && !new RegExp("^[A-Z]{2}\\d{2}" + n + "$", "").test(o)) return !1;
                for (a = o.substring(4, o.length) + o.substring(0, 4), r = 0; r < a.length; r++) "0" !== (i = a.charAt(r)) && (l = !1), l || (d += "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(i));
                for (s = 0; s < d.length; s++) u = ("" + u + d.charAt(s)) % 97;
                return 1 === u
                ...
                "use strict";
                if (this.optional(e)) return !0;
                var a, i = new RegExp(/^[MXYZ]{1}[0-9]{7,8}[TRWAGMYFPDXBNJZSQVHLCKET]{1}$/gi),
                    n = t.substr(t.length - 1).toUpperCase();
                return !((t = t.toString().toUpperCase()).length > 10 || t.length < 9 || !i.test(t)) && (a = 9 === (t = t.replace(/^[X]/, "0").replace(/^[Y]/, "1").replace(/^[Z]/, "2")).length ? t.substr(0, 8) : t.substr(0, 9), "TRWAGMYFPDXBNJZSQVHLCKET".charAt(parseInt(a, 10) % 23) === n)
                ...
                for (var e = [6, 5, 7, 2, 3, 4, 5, 6, 7], a = 0, i = 0; i < 9; i++) a += e[i] * t[i];
                var n = a % 11;
                return (10 === n ? 0 : n) === parseInt(t[9], 10)
            }), "Please specify a valid NIP number."), t.validator.addMethod("nisBR", (function(t) {
                var e, a, i, n, r, s = 0;
                if (11 !== (t = t.replace(/([~!@#$%^&*()_+=`{}\[\]\-|\\:;'<>,.\/? ])+/g, "")).length) return !1;
                for (a = parseInt(t.substring(10, 11), 10), e = parseInt(t.substring(0, 10), 10), n = 2; n < 12; n++) r = n, 10 === n && (r = 2), 11 === n && (r = 3), s += e % 10 * r, e = parseInt(e / 10, 10);
                ...
                return r.data("valid_req_grp", s), t(a).data("being_validated") || (n.data("being_validated", !0), n.each((function() {
                    s.element(this)
                ...
                var n = t(i[1], a.form),
                    ...
                    d = 0 === o || o >= i[0];
                return r.data("valid_skip", s), t(a).data("being_validated") || (n.data("being_validated", !0), n.each((function() {
                    s.element(this)
                ...
                var e, a, i, n, r, s, o = ["A", "B", "C", "D", "E", "F", "G", "H", "J", "K", "L", "M", "N", "P", "R", "S", "T", "U", "V", "W", "X", "Y", "Z"],
